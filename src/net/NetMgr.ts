...
class NetMgr {
	...
	/** ping */
	public async pingServer(params: any): Promise<any>
	{
		let url = GameConfig.getHeadUrl() + "/api/ping";
		return await post(url, params);
	}

	/** 获得服务器配置信息 */
	public async obtainConfig(params: any): Promise<any>
	{
		let url = GameConfig.getHeadUrl() + "/api/game/obtainConfig";
		// console.log(" ===== obtainConfig  url : " + url + "  params" + JSON.stringify(params) + " ===== ");
		return await post(url, params);
	}

	/** 微信登录 */
	public async wxLogin(params: any): Promise<any>
	{
		let url = GameConfig.getHeadUrl() + "/api/game/wxLogin";
		// console.log(" ===== wxLogin  url : " + url + "  params" + JSON.stringify(params) + " ===== ");
		return await post(url, params);
	}

	/** 设置用户数据 */
	public async setJson(params: any): Promise<any>
	{
		let url = GameConfig.getHeadUrl() + "/api/game/setJson";
		// console.log(" ===== setJson  url : " + url + "  params" + JSON.stringify(params) + " ===== ");
		return await post(url, params);
	}
...
// 	}
	...
	// }
	/**解析服务器版本* */
	// private async analysisConfig(str: any): Promise<any> 
	// {
