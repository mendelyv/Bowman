...
//obj         闪烁对象
//interval    闪烁总工时间
//export function blinkEffect(obj,interval:number = 1000,isAuto:boolean = true,call?:any):void{
//    new BitmapBlink(obj,interval,isAuto,call);
//}
//抖动对象特效
//类似ios密码输入错误的特效
...
//抖动对象特效
// 1：抖动  2：震动
//export function shakeScreen(effectType:number = 1,curP:egret.DisplayObjectContainer = null):void{
//    var panel = curP;
//    var shakeNum = 40;
...
* interval      打字间隔 毫秒
*/
//export function typeEffect(obj,content:string = "",interval:number = 200):void{
